  ...
  return (
    <div className="mt-4">
      ...
      <FacebookLogin
        ...
        children={
          <div className="flex items-center justify-center py-2 px-8 bg-white hover:bg-gray-200 text-gray-700 w-72 text-center text-base font-semibold shadow-md rounded-lg">
            <svg
